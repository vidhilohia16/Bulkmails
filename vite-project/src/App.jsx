...
if (response.status === 400) {
  ...
  {alertType === "signup" && (
    <Alert severity="success" variant="filled" sx={{ width:"fit-content",mx:"auto",maxWidth: "350px" ,display:"flex",justifyContent:"center", "& .MuiAlert-icon": {
      my:"auto"}}}>
      <Typography variant='body1' sx={{textAlign:"center",whiteSpace:"nowrap",fontSize: { xs: "15px", md: "16px" }}}>Sign in successful</Typography>
    </Alert>
  )}
  {alertType === "mail" && (
    <Alert severity="success" variant="filled" sx={{ width:"fit-content",mx:"auto",maxWidth: "350px" ,display:"flex",justifyContent:"center", "& .MuiAlert-icon": {
      my:"auto"}}}>
      <Typography  variant='body1' sx={{textAlign:"center",whiteSpace:"nowrap",fontSize: { xs: "15px", md: "16px"  },}}>Mails Sent Successfully</Typography>
    </Alert>
  )}
  {alertType === "loggedin" && (
  ...
  {alertType === "missingfile" && (
    <Alert severity="error" variant="filled" sx={{width:"fit-content",mx:"auto",maxWidth: "350px" ,display:"flex",justifyContent:"center", "& .MuiAlert-icon": {
      my:"auto"}}}>
      <Typography  variant='body1' sx={{textAlign:"center",whiteSpace:"nowrap",fontSize: {xs: "15px", md: "16px" },}}>Excel file is empty</Typography>
    </Alert>
  )}  
  {alertType === "missingcol" && (
    <Alert severity="error" variant="filled" sx={{ width:"fit-content",mx:"auto",maxwidth: "350px",display:"flex",justifyContent:"center", "& .MuiAlert-icon": {
      my:"auto"}}}>
      <Typography  variant='body1' sx={{textAlign:"center",whiteSpace:"nowrap",fontSize: {xs: "15px", md: "16px" },}}>Email column is missing</Typography>
    </Alert>
  )}  
  
</Box>

  <Button variant="outlined" disabled sx={{backgroundColor:"rgba(124,58,237,0.18)",borderColor:"rgba(124,58,237,0.8)",
    borderRadius:"40px",display:"flex",justifyContent:"center",
    margin: "0 auto",mt:"65px",mb:"10px"}}><BoltOutlinedIcon fontSize="small" 
    sx={{color:"#c4b5fd"}}></BoltOutlinedIcon><Typography sx={{textTransform:"none",color:"#c4b5fd"}}>Bulk email,simplified</Typography></Button>
